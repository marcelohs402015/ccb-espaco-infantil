              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-700 leading-relaxed">
                    ...
                    <span className="text-blue-900 font-medium">Caso esqueçam de apagar os dados do dia anterior, o sistema ao entrar e ver que é um novo dia, 
                    vai apagar sozinho os dados do dia anterior.</span>
                  </p>
                </div>
              </div>
            </div>
